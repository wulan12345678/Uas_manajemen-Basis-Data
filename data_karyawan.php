...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
 ...
 <a href="frm_tambah_karyawan.php" class="btn btn-sm btn-primary">Tambah
Data</button></a>
 <br> <br>
...
id="example" style="width:100%">
 ...
 <tr>
 <td><?php echo $no++; ?></td>
 <td><?php echo $rs['nama_karyawan']; ?></td>
 <td><?php echo $rs['tlp']; ?></td>
 <td>
 <a href="frm_ubah_data_karyawan.php?id_karyawan=<?=
$rs['id_karyawan']; ?>"
 class="btn btn-info btn-sm">Ubah</a>
 <a href="hapus_data_karyawan.php?id_karyawan=<?=
$rs['id_karyawan']; ?>" class=" btn btn-danger
 btn-sm">Hapus</a>
 </td>
 </tr>
 <?php
