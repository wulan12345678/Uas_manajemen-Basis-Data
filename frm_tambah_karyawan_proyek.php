...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
 ...
 <h1 class="h2">Form Tambah Karyawan proyek</h1>
 </div>
 <!-- <canvas class="my-4 w-100" id="myChart" width="900" height="380">
</canvas> -->
 <!-- <h4>Data Jadwal Kegiatan</h4> -->
 <div class="table-responsive">
 <form action="simpan_data_karyawan_proyek.php" method="POST">
 <div class="col-6">
 <div class="mb-3">
 ...
 <div class="mb-3">
 <label for="exampleFormControlTextarea1" class="form-label">id karyawan</label>
