...
$queri = mysqli_query($koneksi, "SELECT * FROM tbl_karyawan_proyek where id_pengerjaan=$id");
...
<h1 class="h2">Form Ubah karyawan proyek</h1>
...
<form action="simpan_ubah_data_karyawan_proyek.php" method="POST">
<div class="col-6">
<div class="mb-3">

<label for="exampleFormControlInput1" class="form-
label">id pengerjaan</label>

<input type="text" name="id_pengerjaan" value="<?php echo
...
<input type="text" name="id_karyawan" value="<?php echo
